...
import departmentAnalyticsRoutes from '@/routes/v1/department-analytics.routes';
...
import learningPathRoutes from '@/routes/v1/learning-path.routes';
...
router.use('/manager/department-analytics', departmentAnalyticsRoutes);
